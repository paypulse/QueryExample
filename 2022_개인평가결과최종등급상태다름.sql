...
inner join EVU_EMP ee on (u.EMP_ID= ee.EVU_EMP_ID)
left join EVU_TOT et on (ee.EVU_EMP_NO = et.EVU_EMP_NO)
left join EVU_STAT es on (es.EVU_STEP_CD = ee.CUR_STEP_CD and es.CHASU = ee.CHASU and es.CHASU ='3' )
where ee.EVU_STD_ID ='202201' and et.EVU_TYPE ='C' and es.EVU_STAT_CD ='MD' and et.TOT_GRD_3Q != et.TOT_CFM_GRD_3Q 
order by u.EMP_ID ;
